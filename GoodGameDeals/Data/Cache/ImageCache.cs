...
namespace GoodGameDeals.Data.Cache
{
    ...
    /// </summary>
    public class ImageCache : GoodGameDeals.Data.Cache.CacheBase<BitmapImage>
    {
        ...
        /// </summary>
        public static ImageCache Instance => _instance ?? (_instance = new ImageCache(new HttpClient()));

        /// <summary>
        /// Initializes a new instance of the <see cref="ImageCache"/> class.
        /// </summary>
        public ImageCache(HttpClient client) : base(client)
        {
            this._extendedPropertyNames.Add(DateAccessedProperty);
            this.MaintainContext = true;
        }
        ...
        {
            using (var stream = await baseFile.OpenStreamForReadAsync().ConfigureAwait(this.MaintainContext))
            {
                return await this.InitializeTypeAsync(stream, initializerKeyValues).ConfigureAwait(this.MaintainContext);
            }
        }
        ...
        protected override async Task<bool> IsFileOutOfDateAsync(StorageFile file, TimeSpan duration, bool treatNullFileAsOutOfDate = true)
        {
            ...
            IDictionary<string, object> extraProperties =
                await file.Properties.RetrievePropertiesAsync(this._extendedPropertyNames).AsTask().ConfigureAwait(false);
