...
namespace GoodGameDeals.Data.Cache
{
    ...
    public class FileCache : CacheBase<StorageFile>
    {
        ...
        /// </summary>
        public static FileCache Instance => _instance ?? (_instance = new FileCache(new HttpClient()) { MaintainContext = false });
        ...
        public FileCache(HttpClient httpClient) : base(httpClient) {
        }
    }
}
